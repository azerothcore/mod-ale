...
#ifndef ALEREGISTRY_H
#define ALEREGISTRY_H

#include <sol/forward.hpp>

/*
 * One registration function per Lua type, each defined at the bottom of its
 * methods/<Type>Methods.cpp file. RegisterFunctions (LuaFunctions.cpp) calls
 * them all on engine startup.
 */
